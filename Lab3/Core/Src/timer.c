...
#include "button_n_display.h"
 ...
 void set_Timer2(int duration0){
 	 timer2_inni = duration0 /TIMER_CYCLE;
 	 timer2_counter = timer2_inni;
 	 timer2_flag = 0;
 	 }
  void set_Traffic_Timer(int duration1){
	  traffic_timer_inni = duration1 /TIMER_CYCLE;
	  traffic_timer_counter = traffic_timer_inni;
	  traffic_timer_flag = 0;
  	 }
  void set_Modify_Timer(int duration1){
	  modify_timer_inni = duration1 /TIMER_CYCLE;
